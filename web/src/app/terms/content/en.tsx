/**
 * Terms of use — English, the language the terms were written in and the one
 * that governs where a translation differs (section 21).
 *
 * The constants at the top are the only things that vary by who ships it, and
 * they are the parts counsel has to settle — the DRAFT notice stays on the
 * page until that review has happened.
 */
...
export const en: LegalContent = {
  eyebrow: "Legal",
  title: "Terms of Use",
  lede: "The terms governing use of SC4SAP and the systems it connects to.",
  metaLabels: { effective: "Effective", version: "Version", party: "Provider" },
  effective: EFFECTIVE,
  version: VERSION,
  party: PROVIDER,
  ...
  sections: [
      ...
      body: (
        <>
          <p>
            ...
            and everything else we make available at the same place (together,
            the <strong>Service</strong>). Creating an account, connecting an SAP
            system, or running a single Session means you accept them.
          </p>
          <p>
            If you are accepting on behalf of an employer or a client, you
            confirm that you are authorised to bind that organisation. From that
            point, <em>you</em> in these terms means that organisation, and the
            person who clicked accept is one of its users.
          </p>
          ...
          <p>
            ...
            you are part of this agreement. Where they conflict, the more
            specific document wins: a signed order form first, then a data
            processing agreement, then these terms, then everything else.
          </p>
          ...
          <p>
            ...
            not change these terms, and nothing here relieves you of an
            obligation you owe under them.
          </p>
        </>
      ),
    },
      ...
      body: (
        <>
          <ul>
            ...
            <li>
              <strong>Skill</strong> — a named workflow the Service runs against
              a Connected System: analysing a program, tracing a symptom,
            ...
            <li>
              ...
              everything the Service reads on your instruction: prompts,
              uploaded files, ABAP source, dictionary metadata, configuration
              values, transport contents, and the artefacts a Session generates.
            </li>
            <li>
    ...
    },
    {
      ...
      body: (
        <>
          ...
          <p>
            An account belongs to a single named person. Do not share
            credentials, and do not let anyone else act under your account.
            Every action the Service records against it — every prompt, every
            Skill run, and above all every approval granted at a permission
            prompt — is treated as yours and is attributed to you in the audit
            record.
          </p>
          ...
          <p>
            You remain responsible for activity under your account until you
            have told us, and we are not liable for loss arising before that
            notice reaches us.
          </p>
          ...
          <p>
            ...
            Sessions its users ran, and export or delete them. If your account
            is administered that way, your employer&rsquo;s internal policies
            apply to it alongside these terms.
          </p>
        </>
      ),
    },
      ...
      body: (
        <>
          ...
          <p>
            ...
            Provisioning that user, scoping its authorisations, and reviewing
            them over time is your responsibility. Use a dedicated technical
            user limited to what your work actually needs rather than a personal
            administrator account.
          </p>
          <h3>Tiers are your declaration</h3>
          <p>
            You tell us which tier a profile is. The Service withholds tools on
            that basis, so a production system registered as development will
            be treated as development, with the write tier available against
            it. Label your systems accurately; we cannot detect a mislabelled
            one, and the consequences of a wrong label are yours.
          </p>
          <h3>Reachability and network access</h3>
          <p>
            Getting the Service to a system that is not on the public internet —
            tunnels, allowlists, VPNs, gateway configuration — is your side of
            the line. Do not open a network path that your own security policy
            forbids in order to make a Skill run.
          </p>
          <h3>Licensing</h3>
          <p>
            You confirm that connecting the system breaches neither your
            agreements with SAP nor anyone else&rsquo;s rights, and that you
            hold whatever licences your use of that system requires, including
            for programmatic access. We do not provide SAP licences, we do not
            advise on them, and we are not a party to yours.
          </p>
        </>
      ),
    },
      ...
      body: (
        <>
          ...
          <p>
            ...
            <strong>your own API key</strong>. That usage is billed to you by
            the Model Provider under your agreement with them, not by us. Their
            terms, their acceptable use policy and their availability
            commitments apply to that traffic in addition to these terms, and a
            change on their side can change what the Service can do.
          </p>
          <h3>Set a spend cap</h3>
          <p>
            Token cost tracks how much source and metadata a Session has to
            read. A broad question against a large package can cost many times
            what a narrow one costs, and a Skill that inventories a whole
            package is expensive by design. Set a cap on the key, and treat the
            cap rather than our interface as the thing that stops runaway spend.
          </p>
          ...
          <p>
            ...
            They are not an invoice, they may lag, and where they differ from
            the Model Provider&rsquo;s billing, the Model Provider&rsquo;s
            billing is what you owe.
          </p>
          <h3>Model choice</h3>
          <p>
            We choose which model a Skill runs on and may change that choice —
            for quality, cost, availability, or because a model is retired.
            Output can change as a result. Where a change materially alters
            what you can expect from a Skill, we will say so in the release
            notes.
          </p>
        </>
      ),
    },
    {
      ...
      body: (
        <>
          ...
          <p>
            To answer a question, the Service reads from the Connected System
            and sends what it read to the Model Provider. In practice that means
            ABAP source, dictionary definitions, table and field metadata,
            configuration values, transport contents, and every word you type.
            If a Skill has to look at something to do its job, that thing
            leaves your network.
          </p>
          <p>
            <strong>
            ...
            compliance programme. They cannot classify your data for you, they
            do not know which of your custom tables hold personal data, and
            they are no substitute for your own review.
          </p>
          <h3>What we store</h3>
          <p>
          ...
          <p>
            ...
            except for records we are required to keep. Backups age out on
            their own cycle, so deletion is not instantaneous everywhere.
          </p>
          <h3>Personal data</h3>
          <p>
      ...
      body: (
        <>
          ...
          <p>
            ...
            Sessions running against a tier that is not authorised to write.
            The model cannot call what it cannot see, so this layer cannot be
            talked around by a cleverly worded prompt.
          </p>
          <h3>Layer two — the blocklist</h3>
          <p>
            Extraction of table rows is blocked outright for tables on a
            standing blocklist, which covers banking, payroll and comparable
            data. This layer runs before a request ever reaches you: when it
            fires there is nothing to approve, and no approval granted anywhere
          ...
          <p>
            ...
            automatically after a timeout, and closing the browser denies
            rather than approves.
          </p>
          <h3>An approval is an instruction</h3>
          <p>
            When you allow a call you are directing the Service to make it
            against your system, with your credentials, and you accept the
            result. Read the call before you allow it — the request shows you
            the tool and its exact input for that reason. An approval cannot be
            undone once the call has run.
          </p>
          ...
          <ul>
            ...
            <li>
              widening the SAP user&rsquo;s authorisations to reach data the
              tier withholds;
            </li>
            <li>
          ...
          <p>
            ...
            guarantee that no sensitive value ever appears in a program you
            asked the Service to read, because a value sitting in source code
            is part of the source code. Treat them as one control among yours,
            not as the whole of your controls.
          </p>
        </>
      ),
    },
      ...
      body: (
        <>
          ...
          <p>
            ...
            activate them, and can record them onto transports. Nothing about
            that is a simulation. Once a change is written it exists in your
            system, with your technical user as its author, and undoing it is
            an ordinary SAP task rather than something the Service can reverse
            for you.
          </p>
          <h3>Your change management governs</h3>
          <p>
            Review, approval, testing and release remain yours. The Service has
            no view of your process, does not know your release calendar, and
            does not decide what is fit to move. Nothing it produces is a
            substitute for the sign-off your organisation requires.
          </p>
          <h3>Non-production first</h3>
          <p>
            Run generated work against a development or sandbox system, review
            the diff, and test it before it moves onward. Take a backup or a
            snapshot where the change is not trivially reversible. You decide
            what is released and when, and we are not responsible for what a
            change does downstream once you release it.
          </p>
        </>
      ),
    },
    {
      ...
      body: (
        <>
          ...
          <p>
            The Service is built on a language model, and its Output can be
            wrong, incomplete, or confidently mistaken — including about your
            own code. It can cite a table that does not exist on your system,
            describe behaviour a program does not have, or generate ABAP that
            compiles and still does the wrong thing. Specifications, analyses,
            symptom traces and generated code are drafts for a competent
            reviewer, not deliverables.
          </p>
          <h3>It is not professional advice</h3>
          <p>
            Nothing the Service produces is legal, tax, audit, security,
            accounting or other professional advice, and no advisory
            relationship arises from your use of it. Keep a qualified human
            accountable for anything that reaches a system that matters.
          </p>
          <h3>It is not unique to you</h3>
          <p>
            Similar prompts produce similar Output for different customers. We
            make no claim that Output is original or unique to you, and you
            should not assume it is when you decide how to use it.
          </p>
          ...
          <p>
            ...
            anyone&rsquo;s rights and does not breach a licence you are bound
            by — including SAP&rsquo;s, where the Output touches standard
            objects.
          </p>
        </>
      ),
        ...
        <>
          ...
          <ul>
            ...
            <li>
              ...
              data in bulk, or assemble such a set out of repeated narrow
              queries;
            </li>
            <li>
            ...
            <li>
              resell, sublicense, or expose the Service to third parties as
              though it were your own service, or use it to build or train a
              competing product;
            </li>
            <li>
    ...
    },
    {
      ...
      body: (
        <>
          ...
          <ul>
            <li>
              supervise Sessions that run against systems that matter, rather
              than approving requests without reading them;
            </li>
            <li>
              grant the SAP user the least access the work needs, and review
            ...
            <li>
              make sure the people you let use your account know these terms
              and follow them, and remain responsible for what they do;
            </li>
            <li>
        ...
        <>
          ...
          <p>
            <strong>
              ...
              or share it with anyone beyond the providers needed to run the
              Service.
            </strong>
          </p>
          <h3>Output</h3>
          <p>
            As between you and us, and to the extent it is capable of
            ownership, Output generated for you in a Session is yours, and we
            claim no rights in it. Whether Output is protectable at all is a
            question of the law where you are, not something either of us can
            settle by contract.
          </p>
          ...
          <p>
            ...
            non-transferable, revocable right to use it while your account is
            in good standing, and nothing more. You will not copy, decompile,
            reverse engineer or create derivative works of it except where the
            law says you may despite this clause.
          </p>
          <h3>Feedback</h3>
          <p>
            If you send us feedback, ideas or bug reports, we may use them
            without restriction and without owing you anything. Keep
            confidential material out of feedback.
          </p>
        </>
      ),
    },
      ...
      body: (
        <>
          <p>
            ...
            through this agreement. Each will protect it with at least
            reasonable care, use it only to perform this agreement, and disclose
            it only to people and providers who need it and are bound to
            equivalent obligations.
          </p>
          <p>
            This does not cover information that is public through no fault of
            the receiver, was already known to it without an obligation of
            confidence, is received from a third party free to disclose it, or
            is independently developed without reference to the other&rsquo;s
            material.
          </p>
          <p>
            Either of us may disclose where the law or a court compels it,
            giving the other notice first where that is lawful and practical,
            and disclosing only what is required.
          </p>
        </>
      ),
    },
      ...
      body: (
        <>
          <p>
            ...
            advance for the period you chose, and are non-refundable except
            where the law requires otherwise or where we have said so in
            writing.
          </p>
          <p>
            You are responsible for taxes other than those on our income. Where
            we must collect a tax, we will add it to the invoice.
          </p>
          <p>
            Subscriptions renew for the same period unless you cancel before
            the renewal date. We will give at least thirty days&rsquo; notice
            before a price change takes effect at renewal, and you may cancel
            rather than accept it.
          </p>
          <p>
            Model usage on your own API key is separate throughout, as set out
            in section 6, and is never included in a fee you pay us.
          </p>
        </>
      ),
    },
      ...
      body: (
        <>
          ...
          <p>
            ...
            commitment and offer support on a reasonable-efforts basis through
            the channels listed in the console.
          </p>
          <p>
            Beta and preview features are labelled as such. They may change or
            be withdrawn at any time, may be less reliable than the rest of the
            Service, and carry no availability or support commitment of any
            kind. Do not depend on one for production work.
          </p>
          <p>
            Parts of the Service depend on third parties — the Model Provider
            above all. An outage, a change or a restriction on their side can
            stop the Service from working, and that is outside our control.
          </p>
        </>
      ),
    },
      ...
      body: (
        <>
          ...
          <p>
            ...
            that creates a security, legal or operational risk, or that we are
            required to stop. We will act immediately where the risk is
            immediate; otherwise we will give notice and a reasonable chance to
            put it right. We may also discontinue the Service as a whole on
            reasonable notice, refunding the unused part of any fee you have
            prepaid.
          </p>
          <h3>What happens next</h3>
          <p>
            On termination your right to use the Service ends and live Sessions
            stop. Export what you need before closing the account. Afterwards
            we delete or anonymise Your Content on the schedule in the privacy
          ...
          <p>
            ...
            ownership, confidentiality, fees already due, disclaimers,
            limitation of liability, indemnity, governing law, and this
            sentence.
          </p>
        </>
      ),
      ...
      body: (
        <>
          ...
          <p>
            ...
            uninterrupted, timely or error-free, that a Guardrail will catch
            every case it was built for, that a Session will reach any given
            result, or that Output will be accurate, complete, current,
            non-infringing or suitable for your purposes.
          </p>
          <p>
    ...
    },
    {
      ...
      body: (
        <>
          <p>
            Neither of us is liable for indirect, incidental, special, punitive
            or consequential loss, or for lost profits, lost revenue, lost
            goodwill, business interruption, or lost or corrupted data, however
            caused and on any theory of liability, even if the possibility was
            known.
          </p>
          <p>
          ...
          <p>
            ...
            paid to us, and do not count toward that cap. Neither does the cost
            of repairing, reverting or reworking a change made to a Connected
            System through your account.
          </p>
          <p>
            These limits do not apply to fraud, to wilful misconduct, to death
            or personal injury caused by negligence, or to any liability that
            cannot be limited under the law of {JURISDICTION}. They apply to the
            fullest extent permitted everywhere else, and they survive any
            remedy failing of its essential purpose.
          </p>
        </>
      ),
    },
      ...
      body: (
        <>
          <p>
            ...
            against the damages, losses and reasonable legal costs finally
            awarded or agreed in settlement, arising from:
          </p>
          <ul>
            <li>your use of the Service in breach of these terms;</li>
            <li>Your Content, or the use we make of it on your instruction;</li>
            <li>
              a change made to a Connected System through your account,
              including a claim that you were not authorised to connect that
              system;
            </li>
            <li>
          ...
          <p>
            We will notify you of the claim promptly, let you control the
            defence with counsel of your choice, and give you reasonable
            cooperation at your expense. You will not settle a claim in a way
            that admits fault on our part, or imposes an obligation on us,
            without our consent.
          </p>
        </>
      ),
    },
    {
      ...
      body: (
        <>
          <h3>Assignment</h3>
          <p>
            You may not assign this agreement without our written consent. We
            may assign it to an affiliate or in connection with a merger,
            acquisition or sale of substantially all our assets, on notice to
            you.
          </p>
          ...
          <p>
            ...
            them or on the next business day after delivery, whichever is
            earlier.
          </p>
          ...
          <p>
            ...
            cloud provider or the Model Provider. Payment obligations already
            due are not excused.
          </p>
          <h3>Export and sanctions</h3>
          <p>
            You will comply with export control and sanctions laws that apply
            to your use of the Service, and you confirm you are not located in,
            or acting for anyone in, a territory those laws prohibit us from
            serving.
          </p>
          <h3>Language</h3>
          <p>
      ...
      body: (
        <>
          ...
          <p>
            ...
            bring proceedings where you live, and either of us may seek
      ...
      body: (
        <>
          <p>
            ...
            thirty days before it takes effect, and the effective date and
            version at the top of this page will change with it.
          </p>
          <p>
            Continuing to use the Service after the new terms take effect means
            you accept them. If you do not, close your account before that
            date; where you paid in advance, we will refund the unused part of
            the period.
          </p>
          <p>
            Minor changes — fixing a typo, clarifying wording that does not
            alter an obligation, or naming a new contact address — take effect
            when posted.
          </p>
        </>
      ),
    },
    {
      ...
      body: (
        <>
          <p>
            Questions about these terms, and any notice they require you to
            give us, go to <strong>{CONTACT}</strong>.
          </p>
          <p>
            Suspected vulnerabilities, exposed credentials and anything else
            that cannot wait go to <strong>{SECURITY_CONTACT}</strong>.
          </p>
        </>
      ),
    },
